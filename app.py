...
st.caption("Made in Thiruvananthapuram | For NASA Stardance")
...
try:
    ...
    st.warning("NASA image will loadwhen internet is on - showing demo moon image")
...
if st.button("Make it Frictionless ✨"):
    if notes:
        ...
        st.write("Q1. What is the main topic explained in the first paragraph?")
        st.write("Q2. Explain point 2 in your words according to modern democracy?")
        st.write("Q3. Give a simple example of point 3?")
        st.write("Q4. Justify the importance of democracy in modern society?")
        st.write("Q5. Is democracy the best form of government? Why or Why not?")
    else:
